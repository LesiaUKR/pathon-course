# Напишіть програму на Python, яка включає функцію invite_to_event.
# Ця функція приймає ім'я користувача та повертає персоналізоване запрошення.

# Задачі:

# Створіть функцію invite_to_event, яка приймає один параметр - username.
# Усередині функції використовуйте f-рядок для створення повідомлення з
# персоналізованим ім'ям.
