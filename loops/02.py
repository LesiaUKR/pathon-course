...
# Використовуючи зазначені змінні message, рядок, у якому буде виконуватися пошук, та search, символ,
# який ми шукаємо, підрахуйте, скільки разів символ search зустрічається в рядку message.
